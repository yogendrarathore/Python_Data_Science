...
class maincode:
     ...
     def cur(self):
             ...
             self.develop=Label(self.fm3,text='Developed By - Yogendra Rathore',bg='#fff',fg='blue',
             ...
             self.bt9=Button(self.fm3,text='  Add Student',fg='#fff',bg='#ff0076',font=('Arial',15,'bold'),width=170,
                          height=0,bd=7,relief='flat',cursor='hand2')#command to be added
             self.bt9.place(x=460,y=40)
             self.logo9 = PhotoImage(file='bt1.png')
             self.bt9.config(image=self.logo9, compound=LEFT)
             self.small_logo9 = self.logo9.subsample(1,1)
             self.bt9.config(image=self.small_logo9)


             self.bt10 = Button(self.fm3, text=' Update Student', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
                          width=170,height=0,bd=7, relief='flat',cursor='hand2')#command to be added
             self.bt10.place(x=460, y=120)
             self.log10 = PhotoImage(file='bt7.png')
             self.bt10.config(image=self.log10, compound=LEFT)
             self.small_log10 = self.log10.subsample(1, 1)
             self.bt9.config(image=self.small_log10)

             self.bt11 = Button(self.fm3, text='Create User', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
                          width=170,height=0,bd=7, relief='flat',cursor='hand2')#command to be added
             self.bt11.place(x=460, y=200)
             self.log11 = PhotoImage(file='bt7.png')
             self.bt11.config(image=self.log11, compound=LEFT)
             self.small_log11 = self.log11.subsample(1, 1)
             self.bt11.config(image=self.small_log11)
             

             self.bt12 = Button(self.fm3, text=' Search Student', fg='#fff', bg='#ff0076', font=('Arial', 15, 'bold'),
                          width=170,height=0,bd=7, relief='flat',cursor='hand2')#command to be added
             self.bt12.place(x=460, y=280)
             self.log12 = PhotoImage(file='bt7.png')
     ...
     def addbook(self):
         class temp(maincode):
             ...
             def book(self):
                 ...
                 self.fm1=Frame(self.fm,bg='#fff',width=800,height=360,bd=5,relief='flat')
                 self.fm1.place(x=80,y=15)
                 self.fm2=Frame(self.fm1,bg='#fff',width=400,height=360,bd=5,relief='flat')
                 self.fm2.place(x=0,y=35)
                 self.fm3=Frame(self.fm1,bg='#fff',width=400,height=360,bd=5,relief='flat')
                 self.fm3.place(x=400,y=35)
                 ...
                 #---------------------------Label---------------------------------
                 self.f=Frame(self.fm1,bg='#0f624c',width=790,height=35)
                 self.f.place(x=0,y=0)
                 self.ll=Label(self.f,text='ADD BOOKS',fg='#fff',bg='#0f624c',font=('Arial',12,'bold'))
                 self.ll.place(x=350,y=6)
                 self.lb=Label(self.fm2,text='ID',fg='black',bg='#fff',font=('Arial',10,'bold'))
                 self.lb.place(x=20,y=50)
                 self.lb2 = Label(self.fm2, text='Title', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb2.place(x=20, y=90)
                 self.lb3 = Label(self.fm2, text='Author', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb3.place(x=20, y=130)
                 self.lb4= Label(self.fm2, text='Volume', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb4.place(x=20, y=170)
                 self.lb5 = Label(self.fm2, text='Edition', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb5.place(x=20, y=210)
                 self.lb6 = Label(self.fm2, text='Year', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb6.place(x=20, y=250)
                 self.lb7=Label(self.fm3,text='Publisher',fg='black',bg='#fff',font=('Arial',10,'bold'))
                 self.lb7.place(x=20,y=50)
                 self.lb8 = Label(self.fm3, text='Source', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb8.place(x=20, y=90)
                 self.lb9 = Label(self.fm3, text='Rate', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb9.place(x=20, y=130)
                 self.lb10= Label(self.fm3, text='Bill & Date', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb10.place(x=20, y=170)
                 self.lb11 = Label(self.fm3, text='Category', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb11.place(x=20, y=210)
                 self.lb112 = Label(self.fm3, text='Remark', fg='black', bg='#fff', font=('Arial', 10, 'bold'))
                 self.lb112.place(x=20, y=250)

                 #-------------------------------Entry-------------------------------------

                 self.ee1=Entry(self.fm2,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.ee1.place(x=100,y=50)
                 self.ee2=Entry(self.fm2,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.ee2.place(x=100,y=90)
                 self.ee3=Entry(self.fm2,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.ee3.place(x=100,y=130)
                 self.ee4=Entry(self.fm2,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.ee4.place(x=100,y=170)
                 self.ee5=Entry(self.fm2,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.ee5.place(x=100,y=210)
                 self.ee6=Entry(self.fm2,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.ee6.place(x=100,y=250)
                 
                 self.ee7=Entry(self.fm3,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.ee7.place(x=100,y=50)
                 self.ee8=Entry(self.fm3,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.ee8.place(x=100,y=90)
                 self.ee9=Entry(self.fm3,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.ee9.place(x=100,y=130)
                 self.ee10=Entry(self.fm3,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.ee10.place(x=100,y=170)
                 self.ee11=Entry(self.fm3,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.ee11.place(x=100,y=210)
                 self.ee12=Entry(self.fm3,width=25,bd=4,relief='groove',font=('arial',12,'bold'))
                 self.ee12.place(x=100,y=250)


                 

                 self.bt=Button(self.fm1,text='Submit',width=35,bg='red',fg='#fff',font=('Arial',10,'bold'),bd=3,
                          relief='flat',command=self.submit1)
                 self.bt.place(x=255,y=325)
         ...
         class editing(maincode):
               ...
               def search(self):
                     ...
                     if self.val!=None:
                          ...
                          self.edcat.geometry("300x370+590+320")
                          ...
                          self.labqn = Label(self.edcat, bg='#fff', fg='black', text='Quantity', font=('arial', 10,
                                                                                                    'bold'))
                          self.labqn.place(x=30, y=265)
                         ...
                         #------------------------------Entry------------------------
                          ...
                          self.en6 = Entry(self.edcat, width=25, bd=4, relief='groove',font=('arial',8,'bold'))
                          self.en6.place(x=100, y=265)
                          
                          self.butt = Button(self.edcat, text='Submit', bg='#0f624c', fg='#fff', width=20, height=0,
                                      font=('Arial', 10, 'bold'),command=self.savedit)
                          self.butt.place(x=67, y=310)
     ...
     def search(self):
         class demt(maincode):
             def delmdata(self):
                 ...
                 self.fc1 = Frame(self.fc, bg='#fff', width=500, height=280, bd=5, relief='flat')
                 ...
                 self.lac.place(x=175, y=5)
                 self.label8 = Label(self.fc1, text='Book_Id', bg='#fff', fg='black', font=('arial', 10, 'bold'))
                 self.label8.place(x=85, y=65)
                 self.label9 = Label(self.fc1, text='Title', bg='#fff', fg='black', font=('arial', 10, 'bold'))
                 self.label9.place(x=85, y=105)
                 self.label0 = Label(self.fc1, text='Category', bg='#fff', fg='black', font=('arial', 10, 'bold'))
                 self.label0.place(x=85, y=145)
                 self.label1 = Label(self.fc1, text='Branch', bg='#fff', fg='black', font=('arial', 10, 'bold'))
                 self.label1.place(x=85, y=185)
                 
                 self.entryl= Entry(self.fc1, width=30, bd=4, relief='groove', font=('arial', 8, 'bold'))
                 self.entryl.place(x=188, y=65)
                 self.entry2= Entry(self.fc1, width=30, bd=4, relief='groove', font=('arial', 8, 'bold'))
                 self.entry2.place(x=188, y=105)
                 self.entry3= Entry(self.fc1, width=30, bd=4, relief='groove', font=('arial', 8, 'bold'))
                 self.entry3.place(x=188, y=145)
                 self.entry4= Entry(self.fc1, width=30, bd=4, relief='groove', font=('arial', 8, 'bold'))
                 self.entry4.place(x=188, y=185)
                 self.butto = Button(self.fc1, text='Search', bg='#0f624c', fg='#fff', width=24, height=0,
                                       font=('Arial', 10, 'bold'))#command to be added
                 self.butto.place(x=140, y=220)
     ...
     def show(self):
         class tst(maincode):
             def __init__(self):
                 ...
                 #to be addded in database self.book_table.heading("Count", text="Count")
                 ...
                 #self.book_table.column("Count", width=50)
